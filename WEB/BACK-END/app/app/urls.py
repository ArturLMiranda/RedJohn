...
urlpatterns = [
    ...
    path('api/atividade/<int:id>/', editar_atividade, name='editar_atividade'),  # Usar PUT ou PATCH
    path('api/atividade/<int:id>/', deletar_atividade, name='deletar_atividade'),  # Usar DELETE
    
    # Usuários
    path('api/usuarios/', listar_usuarios, name='listar_usuarios'),
    path('api/usuarios/criar/', criar_usuario, name='criar_usuario'),
    path('api/usuarios/<int:usuario_id>/', editar_usuario, name='editar_usuario'),  # Usar PUT
    ...
    path('api/responsaveis/<int:id>/', deletar_responsavel, name='deletar_responsavel'),  # Usar DELETE
    ...
    path('api/demandantes/<int:id>/', editar_demandante, name='editar_demandante'),  # Usar PUT ou PATCH
    path('api/demandantes/<int:id>/', deletar_demandante, name='deletar_demandante'),  # Usar DELETE
]
